...
- Data de entrega para avaliação final do projeto: `22/08/2022 14:00`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-024-b-project-shopping-cart.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-024-b-project-shopping-cart`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-024-b-project-shopping-cart/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-024-b-project-shopping-cart/pulls) e confira que o seu _Pull Request_ está criado
